public class Main {
    public static void main(String[] args) {
        ...
        String nama = "Naufal";
        // Itu sama dengan:
        String nama2 = new String("Naufal aja");
      ...
      // Cara kalau tidak static
       ...
       m.tambah(x, y);
        ...
        // Contoh pemanggilan Class menjadi Objek (motor)
        ...
        // Contoh pemanggilan Class menjadi Objek (mobil)
        KendaraanBermobil bmA = new KendaraanBermobil("TOYOTA 1GD", 2020);
        KendaraanBermobil bmB = new KendaraanBermobil("TOYOTA Barong", 2016);
